...
var screen_size = Vector2(1024, 600) setget set_screen_size
## Exported variables
...
func _get_property_list() -> Array:
	var properties := [
		...
		{name="screen_size", type=TYPE_VECTOR2, hint=PROPERTY_HINT_NONE},
...
func set_screen_size(value: Vector2) -> void:
	screen_size = value
	material.set_shader_param("screen_size", value)
